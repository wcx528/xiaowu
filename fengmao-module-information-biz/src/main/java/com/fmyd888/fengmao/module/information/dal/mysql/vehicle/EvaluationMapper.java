package com.fmyd888.fengmao.module.information.dal.mysql.vehicle;
...
/**
 * @Title: TestEvaluationMapper
 * @Author: huanhuan
 * @Date: 2023-12-27 11:49
 * @description:
 */
@Mapper
public interface EvaluationMapper extends BaseMapperX<EvaluationDO> {
