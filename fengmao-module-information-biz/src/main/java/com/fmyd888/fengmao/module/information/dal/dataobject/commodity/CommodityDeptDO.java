 ...
 */
@TableName("fm_commodity_dept")
@KeySequence("fm_commodity_dept_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class CommodityDeptDO extends BaseDeptDO {
    /**
     * 组织名称
     */
